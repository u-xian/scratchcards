 ...
 function dispsno(idactno) 
	{	
	  ...
	  $.ajax({
        ...
        data: "id3="+actid,
        success: function() {
		 $("#"+actid).html('<center><a href="./checking/'+fname+'" id="dwn2"><span class="label">Download</span></a></center>');
        }
		});
	}
</script>
    ...
    <tr>
	 <td>
	   <table  id="newspaper-a"> 
	    <thead>
		  <tr>
        	<th COLSPAN=4><center>Activation Check</center></th>
          </tr>
		  <tr>
        ...
        <?php 
          ...
          $result = mysql_query("select a.id,a.creation_date,a.creation_time,a.actno,b.dealername,a.othername from activationno a, dealers b where a.dealerid=b.id and a.status=0 and a.confirmation=1  and  a.finconfirm=1 and a.billingconfirm=0");
		...
		?>
		 <tr>
		  ...
		  <td><a href="#" id="<?php echo $row["id"]; ?>" name="<?php echo $row["actno"]; ?>" onclick="javascript:dispsno(this)" class="button action blue"><span class="label">Validate</span></a></td></tr>
        <?php      
		   }
        ?>
        </tbody>
