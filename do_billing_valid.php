 <?php
  ...
  $user_id=$_SESSION['id_user'];
   ...
   if(isset($_POST['id3'])) 
   {
    ...
    $sql1 = "update activationno set billingconfirm=1,activation_date=curdate(),activation_time=curtime() where id='$bid'";
	mysql_query($sql1);
	
	$sql6 ="update cardsrequest1 set activation_date=curdate() , status=1  where act_id='$bid'";
    mysql_query($sql6);
...
$sql6="select a.names,a.email,a.function,b.location  from users a , logins b where a.id=b.user_id and b.id='$user_id'";
